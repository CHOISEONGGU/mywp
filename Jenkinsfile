pipeline {
  ...
  environment {
    GITNAME = 'CHOISEONGGU'
    GITEMAIL = 'goobschoi@gmail.com'
    GITWEBADD = 'https://github.com/CHOISEONGGU/mywp.git'
    GITSSHADD = 'git@github.com:CHOISEONGGU/mywp.git'
    GITDEPADD = 'git@github.com:CHOISEONGGU/mywp.git'
    GITCREDENTIAL = 'git_cre'
    // github credential 생성시의 ID
    DOCKERHUB1 = '211.183.3.10:5000/mywp'
    DOCKERHUB2 = '211.183.3.10:5000/mydb'
  ...
  stages {
    stage('Checkout Github') {
      steps {
        slackSend (channel: '#jenkins_arlams', color: '#FFFF00', message: "STARTED: Job '${env.JOB_NAME} [${env.BUILD_NUMBER}]' (${env.BUILD_URL})")
